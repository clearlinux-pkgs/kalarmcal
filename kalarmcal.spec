...
Version  : 20.08.3
Release  : 27
URL      : https://download.kde.org/stable/release-service/20.08.3/src/kalarmcal-20.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.3/src/kalarmcal-20.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.3/src/kalarmcal-20.08.3.tar.xz.sig
...
%prep
%setup -q -n kalarmcal-20.08.3
cd %{_builddir}/kalarmcal-20.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604610994
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kalarmcal-20.08.3/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kalarmcal/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5AlarmCalendar.so.5.15.3
