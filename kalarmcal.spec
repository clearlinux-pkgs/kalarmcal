...
Source0  : https://download.kde.org/stable/release-service/20.12.0/src/kalarmcal-20.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.0/src/kalarmcal-20.12.0.tar.xz.sig
...
%prep
%setup -q -n kalarmcal-20.12.0
cd %{_builddir}/kalarmcal-20.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607913386
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kalarmcal-20.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kalarmcal/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5AlarmCalendar.so.5.16.0
